...
if(@$_POST["submit"]) {
    ...
    $guncelle=$db->prepare("UPDATE `blog` SET `baslik`= :baslik,`alt_baslik`= :alt_baslik,`aciklama`= :aciklama,
    ...
    if($guncelle-> execute()) {
        ...
        //print_r($guncelle->errorInfo()); // hata olursa ekrana bastırmak için kullanılır.
