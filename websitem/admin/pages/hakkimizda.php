...
<head>
    ...
    <title> HAKKIMDA BİLİNENLER | PANEL </title>
...
if(@$_POST["submit"]) {
    //tabloyu yazmadan önce boşaltır
...
$cek=$db->prepare("SELECT * FROM `hakkimizda` ORDER BY `id` DESC LIMIT 1 "); //1 TANE VERİNİN ÇEKİLECEĞİNİ GÖSTERİYORUM.
$cek->execute();
...
?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> HAKKIMDA </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="anasayfa.php"class="btn btn-primary"> GERİ DÖN </a>
                        </div>
